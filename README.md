...
|---------|----------|------------|--------------------|
| Jumpbox | Gateway  | 10.0.0.4   | Linux Umbuntu 18.4 |
| Web1    | Server   | 10.0.0.5   | Linux Umbuntu 18.4 |
| Web2    | Server   | 10.0.0.6   | Linux Umbuntu 18.4 |
| ELK     | Monitor  | 10.2.0.4   | Linux Umbuntu 18.4 |
...
6.	Download metricbeat onto ansible by running: 
    ...
    •	curl -L -O https://artifacts.elastic.co/downloads/beats/metricbeat/metricbeat-7.6.1-amd64.deb > /etc/ansible/roles/metricbeat-7.6.1-amd64.deb
